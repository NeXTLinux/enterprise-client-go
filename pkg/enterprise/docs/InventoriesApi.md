...
> DeleteInventory(ctx).InventoryType(inventoryType).Context(context).ImageDigest(imageDigest).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    resp, r, err := api_client.InventoriesApi.DeleteInventory(context.Background()).InventoryType(inventoryType).Context(context).ImageDigest(imageDigest).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InventoriesApi.GetImageInventory(context.Background()).InventoryType(inventoryType).ImageDigest(imageDigest).Context(context).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InventoriesApi.SyncImageInventory(context.Background()).Inventory(inventory).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
