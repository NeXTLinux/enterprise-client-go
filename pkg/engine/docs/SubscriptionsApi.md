...
> []Subscription AddSubscription(ctx).Subscription(subscription).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    resp, r, err := api_client.SubscriptionsApi.AddSubscription(context.Background()).Subscription(subscription).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
> DeleteSubscription(ctx, subscriptionId).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SubscriptionsApi.DeleteSubscription(context.Background(), subscriptionId).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
> []Subscription GetSubscription(ctx, subscriptionId).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SubscriptionsApi.GetSubscription(context.Background(), subscriptionId).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
> []Subscription ListSubscriptions(ctx).SubscriptionKey(subscriptionKey).SubscriptionType(subscriptionType).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SubscriptionsApi.ListSubscriptions(context.Background()).SubscriptionKey(subscriptionKey).SubscriptionType(subscriptionType).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
...
> []Subscription UpdateSubscription(ctx, subscriptionId).Subscription(subscription).XNextlinuxAccount(xNextlinuxAccount).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SubscriptionsApi.UpdateSubscription(context.Background(), subscriptionId).Subscription(subscription).XNextlinuxAccount(xNextlinuxAccount).Execute()
    if err != nil {
