...
func (r ApiQueryImagesByPackageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiQueryImagesByPackageRequest {
...
// The ID of the vulnerability to search for within all images stored in nextlinux-engine (e.g. CVE-1999-0001)
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiQueryImagesByVulnerabilityRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiQueryImagesByVulnerabilityRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
