...
type NullableTagUpdateNotification struct {
	value *TagUpdateNotification
	isSet bool
}

func (v NullableTagUpdateNotification) Get() *TagUpdateNotification {
	return v.value
}

func (v *NullableTagUpdateNotification) Set(val *TagUpdateNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableTagUpdateNotification) IsSet() bool {
	return v.isSet
}
...
func NewNullableTagUpdateNotification(val *TagUpdateNotification) *NullableTagUpdateNotification {
	return &NullableTagUpdateNotification{value: val, isSet: true}
}
