...
type ImagesApi interface {
	...
	*/
	...
	AddImageExecute(r ApiAddImageRequest) ([]NextlinuxImage, *_nethttp.Response, error)
	...
	*/
	...
	//  @return []NextlinuxImage
	GetImageExecute(r ApiGetImageRequest) ([]NextlinuxImage, *_nethttp.Response, error)
	...
	*/
	...
	//  @return []NextlinuxImage
	GetImageByImageIdExecute(r ApiGetImageByImageIdRequest) ([]NextlinuxImage, *_nethttp.Response, error)
	...
	*/
	...
	/*
	GetImageSbomNative Get image sbom in the native Nextlinux format
	...
	*/
	...
	/*
	GetImageSbomNativeJson Get image sbom in the native Nextlinux format
	...
	*/
	...
	//  @return []NextlinuxImage
	ListImagesExecute(r ApiListImagesRequest) ([]NextlinuxImage, *_nethttp.Response, error)
}
...
func (r ApiAddImageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiAddImageRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}

func (r ApiAddImageRequest) Execute() ([]NextlinuxImage, *_nethttp.Response, error) {
...
//  @return []NextlinuxImage
func (a *ImagesApiService) AddImageExecute(r ApiAddImageRequest) ([]NextlinuxImage, *_nethttp.Response, error) {
	var (
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteImageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteImageRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteImageByImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteImageByImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteImagesAsyncRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteImagesAsyncRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}

func (r ApiGetImageRequest) Execute() ([]NextlinuxImage, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []NextlinuxImage
func (a *ImagesApiService) GetImageExecute(r ApiGetImageRequest) ([]NextlinuxImage, *_nethttp.Response, error) {
	var (
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageByImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageByImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}

func (r ApiGetImageByImageIdRequest) Execute() ([]NextlinuxImage, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []NextlinuxImage
func (a *ImagesApiService) GetImageByImageIdExecute(r ApiGetImageByImageIdRequest) ([]NextlinuxImage, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeFilesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeFilesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeImageIdFilesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeImageIdFilesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeImageIdJavapackageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeImageIdJavapackageRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeJavapackageRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeJavapackageRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageContentByTypeMalwareRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageContentByTypeMalwareRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageMetadataByTypeRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageMetadataByTypeRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImagePolicyCheckRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImagePolicyCheckRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImagePolicyCheckByImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImagePolicyCheckByImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageSbomCyclonedxJsonRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageSbomCyclonedxJsonRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageSbomNativeRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageSbomNativeRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageSbomNativeJsonRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageSbomNativeJsonRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageSbomSpdxJsonRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageSbomSpdxJsonRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageVulnerabilitiesByTypeRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageVulnerabilitiesByTypeRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageVulnerabilitiesByTypeImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageVulnerabilitiesByTypeImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageVulnerabilityTypesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageVulnerabilityTypesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetImageVulnerabilityTypesByImageIdRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetImageVulnerabilityTypesByImageIdRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListImageContentRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListImageContentRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListImageContentByImageidRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListImageContentByImageidRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListImageMetadataRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListImageMetadataRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListImagesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListImagesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}

func (r ApiListImagesRequest) Execute() ([]NextlinuxImage, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []NextlinuxImage
func (a *ImagesApiService) ListImagesExecute(r ApiListImagesRequest) ([]NextlinuxImage, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
