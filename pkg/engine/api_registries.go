...
func (r ApiCreateRegistryRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiCreateRegistryRequest {
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteRegistryRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteRegistryRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetRegistryRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetRegistryRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListRegistriesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListRegistriesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiUpdateRegistryRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiUpdateRegistryRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
