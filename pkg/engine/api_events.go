...
func (r ApiDeleteEventRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteEventRequest {
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteEventsRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteEventsRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetEventRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetEventRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListEventsRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListEventsRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
