...
func (r ApiAddPolicyRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiAddPolicyRequest {
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeletePolicyRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeletePolicyRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetPolicyRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetPolicyRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListPoliciesRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListPoliciesRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiUpdatePolicyRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiUpdatePolicyRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
