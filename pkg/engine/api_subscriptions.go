...
func (r ApiAddSubscriptionRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiAddSubscriptionRequest {
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiDeleteSubscriptionRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiDeleteSubscriptionRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiGetSubscriptionRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiGetSubscriptionRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiListSubscriptionsRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiListSubscriptionsRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
...
// An account name to change the resource scope of the request to that account, if permissions allow (admin only)
func (r ApiUpdateSubscriptionRequest) XNextlinuxAccount(xNextlinuxAccount string) ApiUpdateSubscriptionRequest {
	r.xNextlinuxAccount = &xNextlinuxAccount
	return r
}
