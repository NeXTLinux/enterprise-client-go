...
*ImagesApi* | [**GetImageSbomNative**](docs/ImagesApi.md#getimagesbomnative) | **Get** /images/{imageDigest}/sboms/native | Get image sbom in the native Nextlinux format
*ImagesApi* | [**GetImageSbomNativeJson**](docs/ImagesApi.md#getimagesbomnativejson) | **Get** /images/{imageDigest}/sboms/native-json | Get image sbom in the native Nextlinux format
...
*ImportApi* | [**ImportImageArchive**](docs/ImportApi.md#importimagearchive) | **Post** /import/images | Import an nextlinux image tar.gz archive file. This is a deprecated API replaced by the \&quot;/imports/images\&quot; route
...
*SystemApi* | [**DescribeErrorCodes**](docs/SystemApi.md#describeerrorcodes) | **Get** /system/error_codes | Describe nextlinux engine error codes.
